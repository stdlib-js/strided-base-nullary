...
```javascript
import nullary from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-nullary@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-nullary@v0.3.0-deno/mod.js';
```
